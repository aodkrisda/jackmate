...
char Match(IplImage* src)
{
  ...
  //load all 13 glyphs
  IplImage * Glyphs[13];
  Glyphs[0] = cvLoadImage("../imgs/cardA.png"); 
  Glyphs[1] = cvLoadImage("../imgs/card2.png"); 
  Glyphs[2] = cvLoadImage("../imgs/card3.png"); 
  Glyphs[3] = cvLoadImage("../imgs/card4.png"); 
  Glyphs[4] = cvLoadImage("../imgs/card5.png"); 
  Glyphs[5] = cvLoadImage("../imgs/card6.png"); 
  Glyphs[6] = cvLoadImage("../imgs/card7.png"); 
  Glyphs[7] = cvLoadImage("../imgs/card8.png"); 
  Glyphs[8] = cvLoadImage("../imgs/card9.png"); 
  Glyphs[9] = cvLoadImage("../imgs/card10.png"); 
  Glyphs[10] = cvLoadImage("../imgs/cardJ.png"); 
  Glyphs[11] = cvLoadImage("../imgs/cardQ.png"); 
  Glyphs[12] = cvLoadImage("../imgs/cardK.png"); 
