...
void preLoadGlyphs(IplImage * Glyphs[13] ,IpVec ipts[13]){
  ...
  Glyphs[0] = cvLoadImage("D:\\Adi\\blackjack\\visual_projects\\OpenSURFcpp\\HQGlyphs\\cardA.png"); 
  surfDetDes(Glyphs[0], ipts[0], false, 2, 2, 2, 0.001f);
  Glyphs[1] = cvLoadImage("D:\\Adi\\blackjack\\visual_projects\\OpenSURFcpp\\HQGlyphs\\card2.png"); 
  surfDetDes(Glyphs[1], ipts[1], false, 2, 1, 1, 0.000001f);
  Glyphs[2] = cvLoadImage("D:\\Adi\\blackjack\\visual_projects\\OpenSURFcpp\\HQGlyphs\\card3.png"); 
  surfDetDes(Glyphs[2], ipts[2], false, 3, 2, 1, 0.0001f);
  Glyphs[3] = cvLoadImage("D:\\Adi\\blackjack\\visual_projects\\OpenSURFcpp\\HQGlyphs\\card4.png"); 
  surfDetDes(Glyphs[3], ipts[3], false, 3, 2, 1, 0.000001f);
  Glyphs[4] = cvLoadImage("D:\\Adi\\blackjack\\visual_projects\\OpenSURFcpp\\HQGlyphs\\card5.png"); 
  surfDetDes(Glyphs[4], ipts[4], false, 4, 3, 0, 0.000001f); //, 4, 0, 0, 0.000001f
  Glyphs[5] = cvLoadImage("D:\\Adi\\blackjack\\visual_projects\\OpenSURFcpp\\HQGlyphs\\card6.png"); 
  surfDetDes(Glyphs[5], ipts[5], false, 3, 1, 2, 0.0001f);
  Glyphs[6] = cvLoadImage("D:\\Adi\\blackjack\\visual_projects\\OpenSURFcpp\\HQGlyphs\\card7.png"); 
  surfDetDes(Glyphs[6], ipts[6], false, 3, 0, 3, 0.0001f);
  Glyphs[7] = cvLoadImage("D:\\Adi\\blackjack\\visual_projects\\OpenSURFcpp\\HQGlyphs\\card8.png"); 
  surfDetDes(Glyphs[7], ipts[7], false, 4, 2, 0, 0.000001f);
  Glyphs[8] = cvLoadImage("D:\\Adi\\blackjack\\visual_projects\\OpenSURFcpp\\HQGlyphs\\card9.png"); 
  surfDetDes(Glyphs[8], ipts[8], false, 3, 1, 2, 0.0001f);
  Glyphs[9] = cvLoadImage("D:\\Adi\\blackjack\\visual_projects\\OpenSURFcpp\\HQGlyphs\\card10.png"); 
  surfDetDes(Glyphs[9], ipts[9], false, 2, 0, 0, 0.000001f);
  Glyphs[10] = cvLoadImage("D:\\Adi\\blackjack\\visual_projects\\OpenSURFcpp\\HQGlyphs\\cardJ.png"); 
  surfDetDes(Glyphs[10], ipts[10], false, 4, 2, 0, 0.000001f); // , 4, 1, 0, 0.000001f
  Glyphs[11] = cvLoadImage("D:\\Adi\\blackjack\\visual_projects\\OpenSURFcpp\\HQGlyphs\\cardQ.png"); 
  surfDetDes(Glyphs[11], ipts[11], false, 2, 2, 0, 0.000001f);
  Glyphs[12] = cvLoadImage("D:\\Adi\\blackjack\\visual_projects\\OpenSURFcpp\\HQGlyphs\\cardK.png"); 
  surfDetDes(Glyphs[12], ipts[12], false, 1, 2, 1, 0.000001f);

      // Detect and describe interest points in the Glyphs
  printf("\nPre loading Glyphs: ");
  for(int i=0; i<13 ; i++){
  //  surfDetDes(Glyphs[i], ipts[i], false, 4, 2, 1, 0.000001f); // , 4, 2, 1, 0.000001f
																// test -  4, 1, 0, 0.000001f);
	drawIpoints(Glyphs[i], ipts[i]);
	cvShowImage("Glyphs", Glyphs[i]);
	waitKey();
	printf("%d ",i+1);
  }
